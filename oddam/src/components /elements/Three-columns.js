export default function ThreeColumns() {
    return (
        <section className="container__three-columns" id="three_columns">
            <div className="container__three-columns__1 column">
                <ul>
                    <li>10</li>
                    <li>ODDANYCH WORKÓW</li>
                    <li className="subs">Lorem ipsum dolor sit amet, consectetur adipisc Pellentesque vel enim a elit
